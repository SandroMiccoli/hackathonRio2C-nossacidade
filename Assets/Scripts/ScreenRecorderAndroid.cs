...
public class ScreenRecorderAndroid : MonoBehaviour
{
...
//			folder += "/screenshots";
		...
		*/
		...
		//var filename = string.Format("screen_{0}x{1}_{2}.{3}", width, height, counter, format.ToString().ToLower());
		var filename = Application.persistentDataPath + "/screenshot." + format;
			...
			new System.Threading.Thread(() =>
				{
					...
					AJC.CallStatic( "MediaScanFile", context, folder );
					#endif
				}).Start();
